<div class="form-group" id="add-teacher">
<?php
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowTeacher(' . $key . '); return false;', 'id' => 'teacher-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . 'Add Teacher', ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowTeacher()']),
        ]
    ]
]);
echo  "    </div>\n\n";
