    ...
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){
                    if ($model->invoice)
                    {return $model->invoice->id;}
                    else
                    {return NULL;}
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Invoice::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Invoice', 'id' => 'grid-invoice-item-search-invoice_id']
            ],
        [
                'attribute' => 'fee_id',
                'label' => Yii::t('app', 'Fee'),
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Fee::find()->asArray()->all(), 'id', 'description'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
