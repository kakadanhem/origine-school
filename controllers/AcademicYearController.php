...
class AcademicYearController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-semester'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    public function actionView($id)
    {
        ...
        $providerSemester = new \yii\data\ArrayDataProvider([
            'allModels' => $model->semesters,
        ]);
        return $this->render('view', [
            'model' => $this->findModel($id),
            'providerSemester' => $providerSemester,
        ]);
    }
    ...
    /**
     * 
     * Export AcademicYear information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new AcademicYear model by another data,
    ...
    * @return mixed
    */
    public function actionAddSemester()
    {
        if (Yii::$app->request->isAjax) {
            $row = Yii::$app->request->post('Semester');
            if((Yii::$app->request->post('isNewRecord') && Yii::$app->request->post('_action') == 'load' && empty($row)) || Yii::$app->request->post('_action') == 'add')
                $row[] = [];
            return $this->renderAjax('_formSemester', ['row' => $row]);
        } else {
            throw new NotFoundHttpException('The requested page does not exist.');
        }
    }
