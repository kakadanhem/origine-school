...
class SessionController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-schedule', 'add-timetable-session'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * 
     * Export Session information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Session model by another data,
