...
class TeacherController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-group-course-detail'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * 
     * Export Teacher information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Teacher model by another data,
