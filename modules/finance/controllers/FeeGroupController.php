...
class FeeGroupController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-group'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * Deletes an existing FeeGroup model.
    ...
    /**
     * 
     * Export FeeGroup information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new FeeGroup model by another data,
