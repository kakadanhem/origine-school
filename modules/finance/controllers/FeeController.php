...
class FeeController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-enrollmentfee'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * 
     * Export Fee information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Fee model by another data,
