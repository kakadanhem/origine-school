...
class InvoiceController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view','nearly-due', 'create','receipt','create-specific', 'update', 'delete','test-pdf', 'pdf', 'save-as-new', 'add-invoiceitem', 'add-invoicepayment'],
                        'roles' => ['finance-staff']
                    ],
                    [
                        'allow' => true,
                        'actions' => ['index', 'view','nearly-due', 'create','receipt','create-specific', 'update', 'pdf', 'add-invoiceitem', 'add-invoicepayment'],
                        'roles' => ['frontdesk-staff']
                    ],
                    [
                        'allow' => false,
                        'actions' => ['delete'],
    ...
    public function actionView($id)
    {
        ...
        $termStart = date_create($model->enrollment->academicYear->startDate);
        $studentStart = date_create($model->enrollment->enrollDate);
    ...
    public function actionReceipt($id) {
        ...
        $receipt = Receipt::find()->andWhere(['invoice_id' => $model->id])->one();

        $content = $this->renderAjax('_receipt', [
            'model' => $model,
            'providerInvoiceitem' => $providerInvoiceitem,
            'providerInvoicepayment' => $providerInvoicepayment,
