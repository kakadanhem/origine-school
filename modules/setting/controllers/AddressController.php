        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['village-list','address-list','list-province','list-district','list-commune','list-village','index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-guardian', 'add-staff'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    public function actionVillageList($q = null, $id = null) {
        ...
        if (!is_null($q)) {
            ...
            $query->select(["village.id",
                ...
                ->leftJoin('province','district.provinces_id = province.id')
