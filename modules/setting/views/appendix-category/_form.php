...
\mootensai\components\JsBlock::widget(['viewFile' => '_script', 'pos'=> \yii\web\View::POS_END, 
    'viewParams' => [
        'class' => 'Appendix', 
        'relID' => 'appendix', 
        'value' => \yii\helpers\Json::encode($model->appendixes),
        'isNewRecord' => ($model->isNewRecord) ? 1 : 0
    ]
]);
?>

<div class="appendix-category-form">
    ...
    $forms = [
        [
            ...
            'content' => $this->render('_formAppendix', [
                'row' => \yii\helpers\ArrayHelper::toArray($model->appendixes),
            ]),
        ],
    ];
