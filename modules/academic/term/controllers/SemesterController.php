...
namespace app\modules\academic\term\controllers;
...
class SemesterController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-term'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * 
     * Export Semester information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Semester model by another data,
