    ...
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){
                    ...
                    {return $model->academicYear->description;}
                    else
                    {return NULL;}
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\AcademicYear::find()->asArray()->all(), 'id', 'description'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'AcademicYear', 'id' => 'grid-semester-search-academicYear_id']
            ],
