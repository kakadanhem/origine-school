...
class Country extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\app\models\Student::className(), ['nationality_id' => 'id']);
    }
    ...
    public static function find()
    {
        $query = new \app\models\CountryQuery(get_called_class());
        return $query->where(['country.deleted_by' => 0]);
    }
}
