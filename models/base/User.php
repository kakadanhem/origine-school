 ...
 *
 * @property \app\models\Guardian[] $guardians
...
class User extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\app\models\Guardian::className(), ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\app\models\Staff::className(), ['user_id' => 'id']);
    }
