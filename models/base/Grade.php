...
class Grade extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasOne(\app\models\Curriculum::className(), ['id' => 'curriculum_id']);
    }
    ...
    {
        return $this->hasMany(\app\models\Group::className(), ['grade_id' => 'id']);
    }
    ...
    public static function find()
    {
        $query = new \app\models\GradeQuery(get_called_class());
        return $query->where(['grade.deleted_by' => 0]);
    }
}
