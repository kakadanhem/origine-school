...
/**
 * This is the base model class for table "enrollgroup".
 *
 * @property integer $id
 ...
 */
class EnrollGroup extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['enrollment_id', 'group_id', 'relation', 'created_by', 'updated_by', 'deleted_by', 'lock'], 'integer'],
    ...
    /**
     * @inheritdoc
     * @return \app\models\EnrollGroupQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \app\models\EnrollGroupQuery(get_called_class());
