...
/**
 * This is the base model class for table "groupCourseDetail".
 *
 * @property integer $id
 ...
 */
class GroupCourseDetail extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\app\models\Schedule::className(), ['groupCourseDetail_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\models\GroupCourseDetailQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \app\models\GroupCourseDetailQuery(get_called_class());
