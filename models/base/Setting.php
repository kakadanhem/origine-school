    ...
    */
    ...
    public function attributeLabels()
    {
        return [
            ...
            'parameter1' => Yii::t('app', 'Parameter1'),
            'parameter2' => Yii::t('app', 'Parameter2'),
            'parameter3' => Yii::t('app', 'Parameter3'),
            'parameter4' => Yii::t('app', 'Parameter4'),
    ...
    /**
     * @inheritdoc
     * @return \app\models\SettingQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \app\models\SettingQuery(get_called_class());
