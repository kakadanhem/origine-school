...
/**
 * This is the base model class for table "groupGrade".
 *
 * @property integer $id
 ...
 */
class GroupGrade extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\models\GroupGradeQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \app\models\GroupGradeQuery(get_called_class());
