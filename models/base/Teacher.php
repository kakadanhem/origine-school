...
class Teacher extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\app\models\GroupCourseDetail::className(), ['teacher_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\models\TeacherQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \app\models\TeacherQuery(get_called_class());
